...
> [!IMPORTANT]
> **当前 Fork 的目的：** 为 Android 版 OpenAI Provider 增加设备码登录，让无法
> 方便使用手机本地浏览器回调的用户也能完成授权，同时保留原有 API Key 和浏览器
> 回调登录方式。
>
> **是否已经实现：是。** 功能代码已经合入个人默认分支 `main`，用户已经在真实
> Android 设备上完成设备码授权、Provider 保存、应用重启、模型加载和最小真实
> 请求验收。
>
> **当前个人版本：**
> [`0.20-preview-znmlr.1`](https://github.com/yangyunzhao/OpenMinis/releases/tag/0.20-preview-znmlr.1)
> 已发布，并提供 `arm64-v8a` Android Release APK。
...
- 功能开发不直接在 `main` 上进行；设备码登录的历史功能分支
  `feature/openai-device-code-login` 暂时保留，后续修改继续通过独立分支和
  个人仓库 PR 合入 `main`。
- 同步上游时先刷新 `upstream/main`，理解双方修改后再决定 merge 或 rebase；
  发生冲突时不自动选择 `ours` 或 `theirs`。

更完整的远端配置、同步、冲突处理和 Windows 脚本说明见
[个人派生仓库与官方上游同步说明](yangyunzhao-fork/仓库维护/个人派生仓库与官方上游同步说明.md)。

本 README 最初随 `feature/openai-device-code-login` 功能分支交付，随后已通过
个人仓库 [PR #1](https://github.com/yangyunzhao/OpenMinis/pull/1) 合入默认
`main`，现在就是个人仓库的默认首页。
...
[个人派生仓库相对官方上游修改清单](yangyunzhao-fork/仓库维护/个人派生仓库相对官方上游修改清单.md)。
...
- Phase 7：个人仓库首页、修改文件记录、最终交付证据和个人远端推送已完成；
  功能分支已通过个人 PR #1 合入默认 `main`。
- 个人预览版 `0.20-preview-znmlr.1` 已完成 Release 构建、签名与对齐核验、
  66 项设备码聚焦测试，并发布到个人仓库；当前签名、Lint、完整 JVM、真机场景
  和个人更新源限制仍按计划继续处理。
...
- [个人维护文档索引](yangyunzhao-fork/README.md)
- [需求与决策](yangyunzhao-fork/功能/OpenAI设备码登录/需求与决策.md)
- [分阶段实施计划](yangyunzhao-fork/功能/OpenAI设备码登录/分阶段实施计划.md)
- [持续工作记录](yangyunzhao-fork/功能/OpenAI设备码登录/持续工作记录.md)
- [第五阶段自动化回归与调试构建验收报告](yangyunzhao-fork/功能/OpenAI设备码登录/验收/第五阶段自动化回归与调试构建验收报告.md)
- [第六阶段真机验收清单](yangyunzhao-fork/功能/OpenAI设备码登录/验收/第六阶段真机验收清单.md)
- [第七阶段交付验收报告](yangyunzhao-fork/功能/OpenAI设备码登录/验收/第七阶段交付验收报告.md)
- [个人预览版已知限制解释与解决计划](yangyunzhao-fork/版本/0.20-preview-znmlr.1/个人预览版已知限制解释与解决计划.md)
...
- [个人维护文档索引](yangyunzhao-fork/README.md)
- [个人派生仓库与官方上游同步说明](yangyunzhao-fork/仓库维护/个人派生仓库与官方上游同步说明.md)
- [个人 Fork 修改文件清单](yangyunzhao-fork/仓库维护/个人派生仓库相对官方上游修改清单.md)
